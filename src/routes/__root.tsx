...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Frosting Fairy — HOMEMADE CAKES & TREATS" },
      ...
      { property: "og:title", content: "The Frosting Fairy — HOMEMADE CAKES & TREATS" },
      { property: "og:description", content: "Handmade pastries, small-batch treats, and magical baked goods from The Frosting Fairy bakery." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@frostingfairy" },
      { name: "twitter:title", content: "The Frosting Fairy — HOMEMADE CAKES & TREATS" },
      { name: "twitter:description", content: "Handmade pastries, small-batch treats, and magical baked goods from The Frosting Fairy bakery." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/habGkBWx98ZhYlP6GE9dFIC3c0E3/social-images/social-1783959404387-logo.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/habGkBWx98ZhYlP6GE9dFIC3c0E3/social-images/social-1783959404387-logo.webp" },
    ],
    links: [
      {
        rel: "stylesheet",
